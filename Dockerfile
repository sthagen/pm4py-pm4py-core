...
RUN pip3 install deprecation==2.1.0 graphviz==0.20.3 intervaltree==3.1.0 networkx==3.4.2 packaging==24.2 python-dateutil==2.9.0.post0 pytz==2025.1 setuptools==76.1.0 six==1.17.0 sortedcontainers==2.4.0 tzdata==2025.1 wheel==0.45.1 
