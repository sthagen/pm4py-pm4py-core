...
RUN pip3 install deprecation==2.1.0 graphviz==0.20.3 intervaltree==3.1.0 networkx==3.4.2 packaging==24.2 python-dateutil==2.9.0.post0 pytz==2025.1 setuptools==77.0.3 six==1.17.0 sortedcontainers==2.4.0 tzdata==2025.1 wheel==0.45.1 
RUN pip3 install colorama==0.4.6 cycler==0.12.1 pydotplus==2.0.2 pyparsing==3.2.1 tqdm==4.67.1 
RUN pip3 install lxml==5.3.1 numpy==2.2.4 pandas==2.2.3 scipy==1.15.2 
...
RUN pip3 install jsonschema==4.23.0 openai==1.68.0 pyvis==0.3.2 requests==2.32.3 workalendar==17.0.0 
