...
RUN pip3 install deprecation==2.1.0 graphviz==0.20.3 intervaltree==3.1.0 networkx==3.4.2 packaging==25.0 python-dateutil==2.9.0.post0 pytz==2025.2 setuptools==80.0.1 six==1.17.0 sortedcontainers==2.4.0 tzdata==2025.2 wheel==0.45.1 
RUN pip3 install colorama==0.4.6 cycler==0.12.1 pydotplus==2.0.2 pyparsing==3.2.3 tqdm==4.67.1 
RUN pip3 install lxml==5.4.0 numpy==2.2.5 pandas==2.2.3 scipy==1.15.2 
RUN pip3 install contourpy==1.3.2 fonttools==4.57.0 kiwisolver==1.4.8 matplotlib==3.10.1 pillow==11.2.1 
RUN pip3 install anyio==4.9.0 asttokens==3.0.0 attrs==25.3.0 certifi==2025.4.26 charset-normalizer==3.4.1 convertdate==2.4.0 decorator==5.2.1 distro==1.9.0 executing==2.2.0 h11==0.16.0 httpcore==1.0.9 httpx==0.28.1 idna==3.10 ipython==9.2.0 jedi==0.19.2 Jinja2==3.1.6 jsonpickle==4.0.5 jsonschema-specifications==2025.4.1 lunardate==0.2.2 MarkupSafe==3.0.2 matplotlib-inline==0.1.7 parso==0.8.4 prompt-toolkit==3.0.51 pure-eval==0.2.3 pydantic==2.11.4 Pygments==2.19.1 pyluach==2.2.0 PyMeeus==0.5.12 referencing==0.36.2 rpds-py==0.24.0 sniffio==1.3.1 stack-data==0.6.3 traitlets==5.14.3 typing_extensions==4.13.2 urllib3==2.4.0 wcwidth==0.2.13 
RUN pip3 install jsonschema==4.23.0 openai==1.76.2 pyvis==0.3.2 requests==2.32.3 workalendar==17.0.0 
