...
RUN pip3 install graphviz==0.21 networkx==3.6.1 packaging==25.0 python-dateutil==2.9.0.post0 pytz==2025.2 setuptools==80.9.0 six==1.17.0 tzdata==2025.3 wheel==0.46.1 
RUN pip3 install colorama==0.4.6 cycler==0.12.1 pyparsing==3.3.1 tqdm==4.67.1 
RUN pip3 install lxml==6.0.2 numpy==2.4.0 pandas==2.3.3 scipy==1.16.3 
RUN pip3 install contourpy==1.3.3 fonttools==4.61.1 kiwisolver==1.4.9 matplotlib==3.10.8 pillow==12.1.0 
RUN pip3 install anyio==4.12.1 asttokens==3.0.1 attrs==25.4.0 certifi==2026.1.4 charset-normalizer==3.4.4 convertdate==2.4.0 decorator==5.2.1 distro==1.9.0 executing==2.2.1 h11==0.16.0 httpcore==1.0.9 httpx==0.28.1 idna==3.11 ipython==9.9.0 jedi==0.19.2 Jinja2==3.1.6 jsonpickle==4.1.1 jsonschema-specifications==2025.9.1 lunardate==0.2.2 MarkupSafe==3.0.3 matplotlib-inline==0.2.1 parso==0.8.5 prompt-toolkit==3.0.52 pure-eval==0.2.3 pydantic==2.12.5 Pygments==2.19.2 pyluach==2.3.0 PyMeeus==0.5.12 referencing==0.37.0 rpds-py==0.30.0 sniffio==1.3.1 stack-data==0.6.3 traitlets==5.14.3 typing_extensions==4.15.0 urllib3==2.6.2 wcwidth==0.2.14 
RUN pip3 install jsonschema==4.25.1 openai==2.14.0 pyvis==0.3.2 requests==2.32.5 workalendar==17.0.0 
