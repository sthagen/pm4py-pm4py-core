...
RUN pip3 install deprecation==2.1.0 graphviz==0.20.3 intervaltree==3.1.0 networkx==3.4.2 packaging==25.0 python-dateutil==2.9.0.post0 pytz==2025.2 setuptools==80.3.1 six==1.17.0 sortedcontainers==2.4.0 tzdata==2025.2 wheel==0.45.1 
...
RUN pip3 install jsonschema==4.23.0 openai==1.77.0 pyvis==0.3.2 requests==2.32.3 workalendar==17.0.0 
