...
def execute_script():
    net: "ResetInhibitorNet" = ResetInhibitorNet("")
    source: "PetriNet.Place" = ResetInhibitorNet.Place("source")
    sink: "PetriNet.Place" = ResetInhibitorNet.Place("sink")
    p1: "PetriNet.Place" = ResetInhibitorNet.Place("p1")
    p2: "PetriNet.Place" = ResetInhibitorNet.Place("p2")
    p_inhibitor: "PetriNet.Place" = ResetInhibitorNet.Place("p_inhibitor")
    p_reset: "PetriNet.Place" = ResetInhibitorNet.Place("p_reset")
    trans_A: "PetriNet.Transition" = ResetInhibitorNet.Transition("A", "A")
    trans_B: "PetriNet.Transition" = ResetInhibitorNet.Transition("B", "B")
    trans_C: "PetriNet.Transition" = ResetInhibitorNet.Transition("C", "C")
    trans_inhibitor: "PetriNet.Transition" = ResetInhibitorNet.Transition("inhibitor", None)
    trans_free: "PetriNet.Transition" = ResetInhibitorNet.Transition("free", None)
    ...
    inhibitor_arc: "PetriNet.Arc" = add_arc_from_to(p_inhibitor, trans_B, net, type="inhibitor")
    add_arc_from_to(trans_free, p_reset, net)
    reset_arc: "PetriNet.Arc" = add_arc_from_to(p_reset, trans_C, net, type="reset")
    im: "Marking" = Marking({source: 1})
    fm: "Marking" = Marking({sink: 1})
