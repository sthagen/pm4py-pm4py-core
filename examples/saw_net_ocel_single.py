...
def execute_script():
    ...
    nete: StochasticArcWeightNet = StochasticArcWeightNet()
    ime: Marking = Marking()
    fme: Marking = Marking()
    ...
    # ime[sourcee] = 3
    # fme[targete] = 3
    create_order_e: StochasticPetriNet.Transition = StochasticArcWeightNet.Transition(str(uuid4()), "Create Order")
    send_package_e: StochasticPetriNet.Transition = StochasticArcWeightNet.Transition(str(uuid4()), "Send Package")
    item_issue_e: StochasticPetriNet.Transition = StochasticArcWeightNet.Transition(str(uuid4()), "Item Issue")
    item_fixed_e: StochasticPetriNet.Transition = StochasticArcWeightNet.Transition(str(uuid4()), "Item Fixed")
    ...
    nete.places.add(p2e)
    nete.places.add(p3e)
    arc1: PetriNet.Arc = petri_utils.add_arc_from_to(sourcee, create_order_e, nete, type="stochastic_arc")
    arc2: PetriNet.Arc = petri_utils.add_arc_from_to(create_order_e, p1e, nete, type="stochastic_arc")
    arc3: PetriNet.Arc = petri_utils.add_arc_from_to(p1e, skip_e, nete, type="stochastic_arc")
    arc4: PetriNet.Arc = petri_utils.add_arc_from_to(p1e, item_issue_e, nete, type="stochastic_arc")
    arc5: PetriNet.Arc = petri_utils.add_arc_from_to(item_issue_e, p2e, nete, type="stochastic_arc")
    arc6: PetriNet.Arc = petri_utils.add_arc_from_to(p2e, item_fixed_e, nete, type="stochastic_arc")
    arc7: PetriNet.Arc = petri_utils.add_arc_from_to(item_fixed_e, p3e, nete, type="stochastic_arc")
    arc8: PetriNet.Arc = petri_utils.add_arc_from_to(skip_e, p3e, nete, type="stochastic_arc")
    arc9: PetriNet.Arc = petri_utils.add_arc_from_to(p3e, send_package_e, nete, type="stochastic_arc")
    arc10: PetriNet.Arc = petri_utils.add_arc_from_to(send_package_e, targete, nete, type="stochastic_arc")
    arc1.weight = {2: 1, 3: 2}
    arc2.weight = {2: 1, 3: 2}
    arc3.weight = {2: 2, 3: 1}
    arc4.weight = {1: 1}
