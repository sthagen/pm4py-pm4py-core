...
def execute_script():
    ...
    try:
        ...
        embeddings_similarity: "float" = pm4py.embeddings_similarity(powl, process_tree)
        ...
        embeddings_similarity2: "float" = pm4py.embeddings_similarity(process_tree, process_tree)
