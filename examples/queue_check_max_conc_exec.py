...
def execute_script():
    ...
    intervals: list[list[Any]] = pm4py.convert_log_to_time_intervals(log, ('Confirmation of receipt', 'T02 Check confirmation of receipt'))
    interval_tree: IntervalTree = open_paths.interval_to_tree(intervals)
    max_conc_exec: int = 0
