...
def execute_script():
    ...
    enriched_df: "pandas.DataFrame" = pm4py.extract_outcome_enriched_dataframe(dataframe)
    feature_table: "pandas.DataFrame" = pm4py.extract_features_dataframe(enriched_df, include_case_id=True)
    ...
    try:
        ...
        # for example,
        filt_df1: "pandas.DataFrame" = dataframe[dataframe["case:concept:name"].isin(cell_case_dict[('concept:name_T17 Check report Y to stop indication_y', 'org:resource_Resource01_x')])]
        print(filt_df1)
    except:
        traceback.print_exc()
        #input()
    ...
    try:
        ...
        filt_df2: "pandas.DataFrame" = dataframe[dataframe["case:concept:name"].isin(cell_case_dict2[cell])]
        #print(filt_df2)
    except:
        traceback.print_exc()
        #input()
    ...
    try:
        ...
        filt_df3: "pandas.DataFrame" = dataframe[dataframe["case:concept:name"].isin(cell_case_dict3[cell])]
        print(filt_df3)
    except:
        traceback.print_exc()
        #input()
